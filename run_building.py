...
with gpytorch.settings.fast_computations(True,True,True):
    with gpytorch.settings.cholesky_jitter(1):
        DecomposedCausalDiscovery('Data/Building/buildingheating.npy',
                                  tau_max=6, decomp_period=144, decomp_clusters=6, one_cluster=True, ci_test='ParCorr',
...
with gpytorch.settings.fast_computations(True,True,True):
    with gpytorch.settings.cholesky_jitter(1):
        DecomposedCausalDiscovery('Data/Building/buildingheating.npy',
                                  tau_max=6, decomp_period=144, decomp_clusters=6, reuse_clusters=True, ci_test='ParCorr',
